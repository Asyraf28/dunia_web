...
<body style="display: flex; background-image: url('images/level2.png'); background-image: url(/images/level2.png);">
  ...
  <div class="menu-container">
    ...
    <div>
      ...
      <div>
        <a href="/Level2 3" class="soal">
          <button class="button-sublevel"><b>(Soal Nomor 2)</b></a> 
    </div>
    <div>
      <a class="soal">
        <button class="button-sublevel-disable">(Soal Nomor 3)</a>
    </div>
    <div>
      <a class="soal">
        <button class="button-sublevel-disable">(Soal Nomor 4)</a>
    </div>
