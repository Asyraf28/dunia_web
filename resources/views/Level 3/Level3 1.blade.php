...
<div id="cutscene1" class="cutscene-overlay" onclick="hideCutscene()" style="background-color: rgba(10, 10, 10, 0.95);">
  <img src="images/enpisi.png" alt="Notification Image" id="notif-image"></img>
    ...
    <h6>Utopia</h6>  
    Sekarang, coba tuliskan kode untuk membuat sebuah jarak pada button</div>
  </div>
...
<div id="cutscene2" class="cutscene-overlay" onclick="hideCutscene()" style="background-color: rgba(10, 10, 10, 0.95);">
  ...
  <img src="images/enpisi.png" alt="Notification Image" id="notif-image"></img>
    <div class="overlay-text">
    <h6>Utopia</h6>  
    Kamu bisa menggunakan (margin) atau (padding) untuk memberikan jarak antar elemen<br>
    Perhatikan pula (:) dan (;) 
    </div>
  </div>
  ...
  <div class="left-side">
    ...
    <br>
    <p>berikan jarak antar elemen dan border</p>
</div>
...
<div class="login-container">
  <div class="login-form">
    ...
    <div style="margin-left:20px; text-align:left;">
        <a class="soal"><span></span>background-color: #fb9ad0;
        <br>
    border: none;
    <br>
    color: white;
    ...
    <form id="login-form">
      ...
      <button type="submit" id="login-button">Submit</a></button>
    </form>
  </div>
</div>
</div>
...
<script src="js/soal31.js"></script>
