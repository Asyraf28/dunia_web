...
<div id="cutscene1" class="cutscene-overlay" onclick="hideCutscene()" style="background-color: rgba(10, 10, 10, 0.95);">
  <img src="images/enpisi.png" alt="Notification Image" id="notif-image"></img>
    ...
    <h6>Utopia</h6>  
    Mari kita buat tulisan itu berada di tengah</div>
  </div>
...
<div id="cutscene2" class="cutscene-overlay" onclick="hideCutscene()" style="background-color: rgba(10, 10, 10, 0.95);">
  ...
  <img src="images/enpisi.png" alt="Notification Image" id="notif-image"></img>
    <div class="overlay-text">
    <h6>Utopia</h6>  
    Buat tulisan rata tengah. Pakai bahasa inggris.
    Perhatikan pula (:) dan (;) 
    </div>
  </div>
...
<div class="login-container">
  <div class="login-form">
    ...
    <div style="margin-left:20px; text-align:left;">
        <a class="soal"><span></span>text-align: (.............)
            <br>
    ...
    <form id="login-form">
      ...
      <button type="submit" id="login-button"><a href="/Level3 4">Submit</a></button>
    </form>
  </div>
</div>
</div>
...
<script src="js/soal32.js"></script>
