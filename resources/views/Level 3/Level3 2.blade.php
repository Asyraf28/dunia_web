...
<div id="cutscene1" class="cutscene-overlay" onclick="hideCutscene()" style="background-color: rgba(10, 10, 10, 0.95);">
  <img src="images/enpisi_yes.png" alt="Notification Image" id="notif-image"></img>
    ...
    <h6>Utopia</h6>  
    Itu dia, kau berhasil memunculkannya!</div>
  </div>
  ...
  <div class="menu-container">
    ...
    <a class="soal">
      <button class="button-sublevel-done">
        ...
        <a href="/Level3 3" class="soal">
          <button class="button-sublevel"><b>(Soal Nomor 2)</b></button>
</a>

        <a class="soal">
          <button class="button-sublevel-disable">(Soal Nomor 3)</button>
        </a>
