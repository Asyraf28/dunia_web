...
<div id="cutscene3" class="cutscene-overlay" onclick="hideCutscene()" style="background-color: rgba(10, 10, 10, 0.95);">
  ...
  <img src="images/enpisi.png" alt="Notification Image" id="notif-image"></img>
    <div class="overlay-text">
    <h6>Utopia</h6>  
    Perhatikan besar kecil tulisan. Dan fungsi tidak memerlukan (;)
    </div>
  </div>
  ...
  <div class="left-side">
    ...
    <br>
    <p>Buat fungsi untuk mengaktifkan button ketika diklik </p>
</div>
...
<div class="login-container">
  <div class="login-form">
    ...
    <div style="padding: 0 0 30px 0;">
        <a class="soal"><span>(............)('click', () => {</span>
      </div>
      <div class="button-container">
        <a onclick="updateScore(-2, '2')" class="button" style="font-size:small;">A. Button.addEventListener</a>
        <a onclick="updateScore(5, 'nextLevel')" class="button" style="font-size:small;" >B. button.addEventListener</a>
        <a onclick="updateScore(-2, '3')" class="button" style="font-size:small;">C. button.AddEventListener;</a>
      </div>
  </div>
</div>
</div>
