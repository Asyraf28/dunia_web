...
<div id="cutscene2" class="cutscene-overlay" onclick="hideCutscene()" style="background-color: rgba(10, 10, 10, 0.95);">
  <img src="images/enpisi_no.png" alt="Notification Image" id="notif-image"></img>
    <div class="overlay-text">
    <h6>Utopia</h6>  
    {{ $narasi['lv1_2a'] ?? 'Kau tidak dapat menggabungkan tag tersebut!' }}
    </div>
  </div>
<div id="cutscene3" class="cutscene-overlay" onclick="hideCutscene()" style="background-color: rgba(10, 10, 10, 0.95);">
  <img src="images/enpisi_no.png" alt="Notification Image" id="notif-image"></img>
    <div class="overlay-text">
    <h6>Utopia</h6>  
    {{ $narasi['lv1_2b'] ?? 'Bukankah ini terbalik?' }}
    </div>
  </div>
<div id="cutscene4" class="cutscene-overlay" onclick="hideCutscene()" style="background-color: rgba(10, 10, 10, 0.95);">
  <img src="images/enpisi_no.png" alt="Notification Image" id="notif-image"></img>
    <div class="overlay-text">
    <h6>Utopia</h6>  
    {{ $narasi['lv1_2c'] ?? 'Kau membuat ini menjadi pintu' }}
    </div>
  </div>
  ...
  <img src="images/enpisi.png" alt="Notification Image" id="notif-image"></img>
    <div class="overlay-text">
    <h6>Utopia</h6>  
    Ah. Tag <code>&lt;p&gt;</code> berfungsi untuk membuat paragraf. Sedangkan <code>&lt;b&gt;</code> untuk membuat tulisan tebal. <br>
    <b>Jangan lupa untuk membuka dan menutup tag ya.</b>
    </div>
  </div>
  ...
  <div class="left-side">
    ...
    <br>
    <li>Buat tulisan untuk paragraf</li>
    <li>Buat tulisan menjadi tebal</li>
</div>
  ...
  <div class="menu-container">
    <div class="menu-form">
      ...
      <div style="padding: 0 0 30px 0;">
        <a class="soal"><span></span> (..................) &lt;/b&gt&lt/p&gt;</a>
      </div>
      <div>
        <h1 style="color: rgb(189, 43, 226); font-size: 15px;">Pilih Jawabannya!</h1>
      </div>
      <div class="button-container">
        <a class="button" onclick="updateScore(-2, '2')">{{ $soal['lv1_2a'] ?? '<h1><p>Hello' }}</a>
        <a class="button" onclick="updateScore(-2, '3')">{{ $soal['lv1_2b'] ?? '<b><p>Hello' }}</a>
        <a class="button" onclick="updateScore(-2, '4')">{{ $soal['lv1_2c'] ?? '<b><a>Hello' }}</a>
        <a class="button" onclick="updateScore(5, 'nextLevel')">{{ $soal['lv1_2d'] ?? '<p><b>Hello' }}</a>
