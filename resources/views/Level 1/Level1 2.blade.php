...
<body style="background-image: url('images/level1.png'); background-image: url(/images/level1.png);">
  ...
  <img src="images/enpisi.png" alt="Notification Image" id="notif-image"></img>
    ...
    <h6>Utopia</h6>  
    {{ $narasi['lv1_1o'] ?? 'Tunggu, sepertinya ini untuk membuat judul dunia ini. Kira-kira bagaimana ya cara membuatnya?' }}
    </div>
  </div>
...
<div id="cutscene2" class="cutscene-overlay" onclick="hideCutscene()" style="background-color: rgba(10, 10, 10, 0.95);">
  <img src="images/enpisi_no.png" alt="Notification Image" id="notif-image"></img>
    <div class="overlay-text">
    <h6>Utopia</h6> 
    {{ $narasi['lv1_1a'] ?? 'Bukankah ini terlalu besar?!' }}
    </div>
  </div>
<div id="cutscene3" class="cutscene-overlay" onclick="hideCutscene()" style="background-color: rgba(10, 10, 10, 0.95);">
  <img src="images/enpisi_no.png" alt="Notification Image" id="notif-image"></img>
    <div class="overlay-text">
    <h6>Utopia</h6>  
    {{ $narasi['lv1_1b'] ?? 'Mungkin kau salah tag?' }}
    </div>
  </div>
<div id="cutscene4" class="cutscene-overlay" onclick="hideCutscene()" style="background-color: rgba(10, 10, 10, 0.95);">
  <img src="images/enpisi_no.png" alt="Notification Image" id="notif-image"></img>
    <div class="overlay-text">
    <h6>Utopia</h6>  
    {{ $narasi['lv1_1d'] ?? 'Ini terlalu biasa untuk judul halaman!' }}
    </div>
  </div>
  ...
  <img src="images/enpisi.png" alt="Notification Image" id="notif-image"></img>
    <div class="overlay-text">
    <h6>Utopia</h6>  
    Yang kuingat, tag untuk membuat judul adalah <code>&lt;h1&gt;</code><code>&lt;h2&gt;</code> hingga <code>&lt;h6&gt;</code>
    </div>
  </div>
  ...
  <div class="left-side">
    <div style="display:flex;">
      ...
      <br>
    <p>Buat judul tulisan paling besar</p>
  </div>
<div class="right-side">
  <div class="menu-container">
    <div class="menu-form">
      ...
      <div >
          <button class="button" onclick="updateScore(-2, '2')" style="font-size:small;">{{ $soal['lv1_1a'] ?? '<h2>Dunia Web</h2>' }}</button>
          <button class="button" onclick="updateScore(-2, '3')" style="font-size:small;">{{ $soal['lv1_1b'] ?? '<head>Dunia Web</head>' }}</button>
          <button class="button" onclick="updateScore(5, 'nextLevel')" style="font-size:small;">{{ $soal['lv1_1c'] ?? '<h1>Dunia Web</h1>' }}</button>
          <button class="button" onclick="updateScore(-2, '4')" style="font-size:small;">{{ $soal['lv1_1d'] ?? '<p>Dunia Web<p>' }}</button>
      </div>
    </div>
  </div>
</div>
